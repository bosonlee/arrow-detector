...
set(MSG_I_FLAGS "-Itest:/home/bosonlee/arrow_test/src/test/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/bosonlee/arrow_test/src/test/msg/detector.msg" NAME_WE)
add_custom_target(_test_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test" "/home/bosonlee/arrow_test/src/test/msg/detector.msg" ""
)
...
_generate_msg_cpp(test
  "/home/bosonlee/arrow_test/src/test/msg/detector.msg"
  "${MSG_I_FLAGS}"
  ""
